 ...
 */
public class NetworkJudgmentUtil {

    public NetworkJudgmentUtil() {
    ...
    private static final int NETWORK_TYPE_GSM = 16; // GSM 网络
    private static final int NETWORK_TYPE_TD_SCDMA = 17; // SCDMA 全球网络无线通信
